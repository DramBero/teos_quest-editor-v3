    ...
    <div class="header-content">
      ...
      <div class="header-dependencies">
        <transition-group
          ...
          animation="200"
        >
          <div class="header-dependencies__item" v-for="dep in dependencies" :key="dep[0]">
            <span>{{ dep[0] }}</span>
      ...
      <div class="header-buttons">
        <button class="modal-button header-buttons__button" @click="saveHeader">Save</button>
        <button class="modal-button header-buttons__button" @click="cancelChanges">Cancel</button>
      </div>
    </div>
  </div>
</template>
